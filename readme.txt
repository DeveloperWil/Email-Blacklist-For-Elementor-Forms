...
= Plugin Page =
[Email Blacklist For Elementor Forms](https://zeropointdevelopment.com/wordpress-plugins/email-blacklist-for-elementor-forms/ "Email Blacklist For Elementor Forms WordPress Plugin")

== Installation ==

0. Ensure you are using Elementor Pro
1. Download the plugin zip file & unzip it
2. Copy the folder email-blacklist-for-elementor-forms into the directory /wp-content/plugins/
